...
<!-- Title -->
<title>Labortech Laboratory</title>
...
<?php include "frontend_slider.php"; ?>
<!--feature start-->
  ...
  <div class="container">
    <div class="row align-items-center justify-content-between">
      <div class="col-lg-5 col-12 order-lg-1">
        <img class="img-fluid" src="frontend/images/about/01.jpg" alt="">
      </div>
      <div class="col-lg-7 col-12 mt-6 mt-lg-0">
        <div class="row align-items-end">
          ...
          <div class="col-md-5 mt-6 mt-md-0">
            ...
            <img class="img-fluid" src="frontend/images/sign.png" alt="">
  ...
  <div class="container-fluid ps-0">
    <div class="row">
      <div class="col-lg-7 col-md-10 col-11">
        <div class="dark-bg p-lg-7 p-4 pb-10 custom-pt-1" data-bg-img="frontend/images/pattern/02.png">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-10 col-12 ms-auto ps-0">
        <div class="position-relative overflow-hidden img-border mt-n15 custom-mt-0">
          <img class="img-fluid w-100" src="frontend/images/about/02.jpg" alt="">
        ...
        <div class="owl-carousel no-pb" data-dots="false" data-items="6" data-md-items="4" data-sm-items="3" data-xs-items="2" data-margin="20" data-autoplay="true">
          <div class="item">
            <div class="client-logo">
              <img class="img-fluid" src="frontend/images/client/09.png" alt="">
            </div>
          </div>
          <div class="item">
            <div class="client-logo">
              <img class="img-fluid" src="frontend/images/client/10.png" alt="">
            </div>
          </div>
          <div class="item">
            <div class="client-logo">
              <img class="img-fluid" src="frontend/images/client/11.png" alt="">
            </div>
          </div>
          <div class="item">
            <div class="client-logo">
              <img class="img-fluid" src="frontend/images/client/12.png" alt="">
            </div>
          </div>
          <div class="item">
            <div class="client-logo">
              <img class="img-fluid" src="frontend/images/client/13.png" alt="">
            </div>
          </div>
          <div class="item">
            <div class="client-logo">
              <img class="img-fluid" src="frontend/images/client/14.png" alt="">
            </div>
          </div>
          <div class="item">
            <div class="client-logo">
              <img class="img-fluid" src="frontend/images/client/15.png" alt="">
            </div>
          </div>
          <div class="item">
            <div class="client-logo">
              <img class="img-fluid" src="frontend/images/client/16.png" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="owl-carousel no-pb popup-gallery" data-dots="false" data-items="5" data-md-items="3" data-sm-items="2" data-xs-items="1" data-margin="10">
          <div class="item">
            <div class="cases-item position-relative overflow-hidden">
              <img class="img-fluid w-100" src="frontend/images/project/01.jpg" alt="">
              <a class="popup-img" href="frontend/images/project/large/01.jpg"> <i class="las la-plus"></i>
              </a>
          ...
          <div class="item">
            <div class="cases-item position-relative overflow-hidden">
              <img class="img-fluid w-100" src="frontend/images/project/02.jpg" alt="">
              <a class="popup-img" href="frontend/images/project/large/02.jpg"> <i class="las la-plus"></i>
              </a>
              <div class="cases-title"> <span>Pathology</span>
                <h4><a href="research-single.html">Personnel Competence</a></h4>
              </div>
          ...
          <div class="item">
            <div class="cases-item position-relative overflow-hidden">
              <img class="img-fluid w-100" src="frontend/images/project/03.jpg" alt="">
              <a class="popup-img" href="frontend/images/project/large/03.jpg"> <i class="las la-plus"></i>
              </a>
              <div class="cases-title"> <span>Pathology</span>
                <h4><a href="research-single.html">Personnel Competence</a></h4>
              </div>
          ...
          <div class="item">
            <div class="cases-item position-relative overflow-hidden">
              <img class="img-fluid w-100" src="frontend/images/project/04.jpg" alt="">
              <a class="popup-img" href="frontend/images/project/large/04.jpg"> <i class="las la-plus"></i>
              </a>
              <div class="cases-title"> <span>Pathology</span>
                <h4><a href="research-single.html">Personnel Competence</a></h4>
              </div>
          ...
          <div class="item">
            <div class="cases-item position-relative overflow-hidden">
              <img class="img-fluid w-100" src="frontend/images/project/05.jpg" alt="">
              <a class="popup-img" href="frontend/images/project/large/05.jpg"> <i class="las la-plus"></i>
              </a>
              <div class="cases-title"> <span>Pathology</span>
                <h4><a href="research-single.html">Personnel Competence</a></h4>
              </div>
      ...
      <div class="col-lg-6 ms-auto mt-5 mt-lg-0">
        <div class="row">
          <div class="col-sm-6">
            <div class="team-member">
              <div class="team-images">
                <img class="img-fluid" src="frontend/images/team/01.jpg" alt="">
              </div>
          ...
          <div class="col-sm-6 mt-5 mt-sm-0">
            <div class="team-member">
              <div class="team-images">
                <img class="img-fluid" src="frontend/images/team/02.jpg" alt="">
              </div>
              <div class="team-description">
          ...
          <div class="col-sm-6 mt-5">
            <div class="team-member">
              <div class="team-images">
                <img class="img-fluid" src="frontend/images/team/03.jpg" alt="">
              </div>
              <div class="team-description">
          ...
          <div class="col-sm-6 mt-5">
            <div class="team-member">
              <div class="team-images">
                <img class="img-fluid" src="frontend/images/team/04.jpg" alt="">
              </div>
              <div class="team-description">
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
        ...
        <div class="card post-card border-0 rounded-0 shadow-sm bg-transparent">
          <img class="card-img-top" src="frontend/images/blog/01.jpg" alt="Image">
      ...
      <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
        <!-- Blog Card -->
        <div class="card post-card border-0 rounded-0 shadow-sm bg-transparent">
          <img class="card-img-top" src="frontend/images/blog/02.jpg" alt="Image">
          <div class="card-body px-4 pb-4 pt-0">
            <div class="mt-n3">
              <div class="d-inline-block white-bg px-2 py-1 text-black box-shadow">20 February</div>
            </div>
      ...
      <div class="col-md-6 col-lg-4">
        <!-- Blog Card -->
        <div class="card post-card border-0 rounded-0 shadow-sm bg-transparent">
          <img class="card-img-top" src="frontend/images/blog/03.jpg" alt="Image">
          <div class="card-body px-4 pb-4 pt-0">
            <div class="mt-n3">
              <div class="d-inline-block white-bg px-2 py-1 text-black box-shadow">20 February</div>
            </div>
