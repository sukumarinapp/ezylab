...
$ClientInfo = SelectParticularRow('macho_customers', 'id', $customer_id);
...
$mpdf->SetFont('Arial', 'B', 8);
$mpdf->Cell(140, 4, $ClientInfo['C_name'], 'LRT', 0, 'L', false);
$mpdf->SetFont('Arial', '', 8);
$mpdf->Cell(40, 4, '', 'LRT', 1, 'L', false);
$mpdf->Cell(140, 4, WordReplace($ClientInfo['address1']), 'LR', 0, 'L', false);
$mpdf->Cell(40, 4, '', 'LR', 1, 'L', false);
$mpdf->SetFont('Arial', '', 8);
$mpdf->Cell(140, 4, 'T.Name: ' . $ClientInfo['T_name'], 'LR', 0, 'L', false);
...
if ($BillData['bill_id'] != 0) {
    ...
    $mpdf->SetFont('Arial', 'B', 8);
    $mpdf->Cell(85, 8, CustomerBillNo($BillData['bill_id']), 'R', 1, 'C', false);
}

$mpdf->SetFont('Arial', '', 8);
$mpdf->Cell(10, 8, ++$no . '.', 'LR', 0, 'C', false);
$mpdf->Cell(85, 8, 'Description', 'LR', 0, 'C', false);
$mpdf->SetFont('Arial', 'B', 8);
$mpdf->Cell(85, 8, $BillData['description'], 'R', 1, 'C', false);
...
$mpdf->Cell(90, 4, "Customer's Seal and Signature", 'L', 0, 'L', false);
$mpdf->SetFont('Arial', 'B', 6);
