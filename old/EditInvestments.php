                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="saving_account" id="saving_account" class="form-control"
                                tabindex="5">
                            <option value="12" <?php if($FinanceData['saving_account'] == '12') echo 'selected';?>>Cash on Hand</option>
                            <option value="9" <?php if($FinanceData['saving_account'] == '9') echo 'selected';?>>Bank Account</option>
                        </select>
                    </div>
                </div>
