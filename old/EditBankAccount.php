                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control"
                                tabindex="1">
                            <option value="Income" <?php if($FinanceData['type'] == 'Income') echo 'selected';?> >Credit</option>
                            <option value="Expense" <?php if($FinanceData['type'] == 'Expense') echo 'selected';?> >Debit</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="pay_for" id="pay_for" class="form-control" maxlength="200"
                               value="<?php echo $FinanceData['pay_for'];?>" tabindex="2"/>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Payment Method</label>
                        <select name="payment_method" id="payment_method" class="form-control" tabindex="3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="reference_no" id="reference_no" class="form-control" maxlength="100"
                               value="<?php echo $FinanceData['reference_no'];?>" tabindex="4"/>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Amount</label>
                        <input type="text" name="amount" id="amount" class="form-control"
                               value="<?php echo $FinanceData['amount'];?>" onkeypress="return isNumberDecimalKey(event)" tabindex="5"/>
                    </div>
                </div>
                <div class="card-footer">
                    <div class="clearfix">
                        <div class="float-right">
                            <button class="btn btn-warning" type="submit" name="Update" tabindex="6">Save Changes
                            </button>
