...
<!-- meta tags -->
<meta charset="utf-8">
<meta name="keywords" content="ichroma™ II/>
<meta name="description" content="ichroma™ II" />
<meta name="author" content="www.themeht.com" />
<meta name="viewport" content="width=device-width, initial-scale=1">

<!-- Title -->
<title>ichroma™ II</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <h1 class="text-theme">ichroma™ <span class="text-black">II </span></h1>
        <nav aria-label="breadcrumb" class="page-breadcrumb border-top border-light pt-3 mt-3">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ichroma</li>
          </ol>
        </nav>
        </div>
      </div>
