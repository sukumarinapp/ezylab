...
foreach ($TestEntryResult as $TestEntryData) {
    ...
    foreach ($TestEntryResult2 as $TestEntryData2) {
        ...
        $TestEntryQuery3 = "SELECT * FROM test_entry WHERE entry_id='$id' AND dept_id='$dept_id' AND test_category='$test_category'  ORDER BY sub_heading,test_id";
        ...
        foreach ($TestEntryResult3 as $TestEntryData3) {
            ...
            if ($type_test == 'Normal') {
                ...
                if($TestEntryData3['comments'] == 1 && $TestTypeData['critical_info'] != ""){
                ...
                if($TestEntryData3['interpretation'] == 1 && $TestTypeData['interpretation'] != ""){
