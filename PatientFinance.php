                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control number" name="total_pay_amount" id="total_pay_amount"
                                    value="">
                                <input type="text" class="form-control" name="pay_amount" id="pay_amount" value="" onkeypress="return isNumberDecimalKey(event)">
                            </div>
                            <div class="form-group">
