  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <h1 class="text-theme">About  <span class="text-black"> Us </span></h1>
...
<section class="pt-0">
  <div class="container">
    <div class="row">
      <div class="col">
        <div class="white-bg z-index-1 border-top border-start border-light">
          <div class="row g-0">
            <div class="col-lg-4">
...
<section class="custom-pb-2 theme-bg">
  <div class="container">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 col-md-7">
        <div class="section-title mb-0">
          <h2 class="title text-white mb-0">We Provide All Aspects Of Medical Practice For Your Whole Family! </h2> 
        </div>
      </div>
      <div class="col-lg-6 col-md-5 mt-5 mt-md-0 text-md-end">
        <a class="btn btn-white" href="our-service.html"> <span>View All Services</span>
        </a>
      </div>
    </div>
  </div>
...
<section class="pt-0 mt-n15">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-4 col-md-6">
        <div class="service-item style-3 text-center">
          <div class="service-img">
            <img class="img-fluid" src="images/services/05.jpg" alt="">
          </div>
          <div class="service-desc pt-6 white-bg shadow-none">
            ...
            <div class="pt-4 mt-4 border-top border-light"> <a class="btn-link text-black" href="biochemistry-solution.html">Read More...</a> 
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
        <div class="service-item style-3 text-center active">
          <div class="service-img">
            <img class="img-fluid" src="images/services/06.jpg" alt="">
          </div>
          <div class="service-desc pt-6 white-bg shadow-none">
            ...
            <p>We have put protocols to protect our patients and staff care.</p>
            <div class="pt-4 mt-4 border-top border-light"> <a class="btn-link text-black" href="pharmaceutical-research.html">Read More...</a> 
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mt-5 mt-lg-0">
        <div class="service-item style-3 text-center">
          <div class="service-img">
            <img class="img-fluid" src="images/services/07.jpg" alt="">
          </div>
          <div class="service-desc pt-6 white-bg shadow-none">
            ...
            <p>We have put protocols to protect our patients and staff care.</p>
            <div class="pt-4 mt-4 border-top border-light"> <a class="btn-link text-black" href="pathologycam-testing.html">Read More...</a> 
            </div>
          </div>
        </div>
      </div>
