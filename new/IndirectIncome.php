...
if (isset($_POST['submit'])) {
    ...
    if (is_int($insert_income)) {
        ...
        $notes = 'Indirect Income :<br>' . $_POST['pay_for'] . 'Rs.' . $_POST['amount'] . ' Amount added by ' . $user;
        $receive_id = '1';
            ...
            <div class="ml-auto">
                <div class="btn-group">
                    <button class="btn btn-secondary" type="button"
                            onclick="print_data(event,'Indirect Income Report','<?php echo $start_date; ?>','<?php echo $end_date; ?>');">
                        <i class="fa fa-print"></i>
                        Print
                    </button>
                    <button class="btn btn-secondary" type="button"
                            onclick="pdf_data(event,'Indirect Income Report','<?php echo $start_date; ?>','<?php echo $end_date; ?>');">
                        <i
                            class="fa fa-file-pdf-o"></i> PDF
                    </button>
                    <button class="btn btn-secondary" type="button"
                            onclick="excel_data(event,'Indirect Income Report','<?php echo $start_date; ?>','<?php echo $end_date; ?>');">
                        <i
                    ...
                    <?php if ($PageAccessible['is_write'] == 1) { ?>
                        ...
                        <div class="card-title pull-right">
                            <button class="btn btn-labeled btn-secondary" type="button" data-toggle="modal"
                                    data-target="#add_income">Create New
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Add Indirect Income Details</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-xl-12">
                        <form method="post" action="IndirectIncome">
                            <!-- START card-->
...
<div class="modal fade" id="edit_income" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Update Indirect Income Details</h4>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    window.onload = function () {
        ...
        if (document.getElementById('insert_success')) {
            swal("Success!", "New Indirect Income Details has been Added!", "success");
        }
        ...
        if (document.getElementById('update_success')) {
            swal("Success!", "Indirect Income has been Updated!", "success");
        }
