                                        ...
                                        <select class="form-select" name="test_name" id="test_name"
                                            ...
                                            foreach ($TestCategoryResult as $TestCategoryData) {
                                                ...
                                                foreach ($TestTypeResult as $TestTypeData) {
                                                    ...
                                                    echo "<option  value='test_id_" . $TestTypeData['id'] . "'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $TestTypeData['test_name'] . ' - ' . $TestTypeData['test_code'] . "</option>";
                                                }
                                            }
                                            ?>
                                        </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pull-right">
                                ...
                                <input type="text" name="profile_name" id="profile_name" class="form-control"
                                    value="<?= $ProfileData['category_name']; ?>">
                            </div>
                            ...
                            <div class="col-md-3 pull-right">
                                <input style="text-align: right" readonly type="text" name="total_amount"
                                    id="total_amount" class="form-control" value="<?= $ProfileData['amount']; ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <label class="col-form-label">Notes </label>
                                <textarea class="form-control" name="notes" id="notes" maxlength="100"
...
<script>
    function load_bill_products2() {
        var profile_id = $('#profile_id').val();
        $.ajax({
            type: 'POST',
            url: 'load_bill_data2.php',
            data: {
