...
if (isset($_POST['submit'])) {
    ...
    if (is_int($insert_income)) {
        ...
        $notes = 'Income :<br>' . $_POST['pay_for'] . 'Rs.' . $_POST['amount'] . ' Amount added by ' . $user;
        $receive_id = '1';
                ...
                <div class="card-body">
                    <table class="table table-striped my-4 w-100" id="datatable1">
                        ...
                        <tbody>
                            ...
                            $FinanceQuery = "SELECT * FROM macho_revenue WHERE type='$type' AND entry_date>='$start_date' AND entry_date<='$end_date' ORDER BY id DESC ";
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <?php if ($FinanceData['edit_status'] == 1) {
                                                    if ($FinanceData['account_id'] == $account_id) {
