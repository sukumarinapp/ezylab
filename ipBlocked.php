            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped my-4 w-100" id="datatable1">
                        ...
                        <?php
                        $no = 0;
                        $TrackQuery = "SELECT * FROM `macho_ip_tracking` WHERE blocked='1' ORDER BY id DESC ";
                        ...
                        if ($TrackCounts > 0) {
                            foreach ($TrackResult as $TrackData) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-10">
                                            <label class="switch " title="<?php if ($TrackData['blocked'] == 1) {
                                                echo 'Active';
                                            } else {
                                                echo 'In-Active';
                                            } ?>">
                                                <input type="hidden" name="block_value" id="block_value"
                                                       value="<?php echo $TrackData['blocked']; ?>">

                                                <input type="checkbox" <?php if ($TrackData['blocked'] == 1) {
                                                    echo 'checked="checked"';
                                                } ?> onchange="block_calling(<?php echo $TrackData['id']; ?>)">
                                                <span></span
                                            </label>
                                        </div>
                                    </td>
